...
<div class="wrapper">
    <div class="container">
        ...
        <div class="block block-form">
            <div class="block-action" onclick="openBlock('add-developer')">
                <span class="action-description">Add developer</span>
            </div>

            <div class="form-container" id="add-developer" style="display:none; float: left">
                <div class="form">
                    <form action="${pageContext.request.contextPath}/project-developers?${pageContext.request.getQueryString()}" method="POST">
